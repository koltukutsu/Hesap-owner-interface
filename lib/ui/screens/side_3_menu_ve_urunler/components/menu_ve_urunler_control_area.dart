...
import 'package:hesap_owner_interface/ui/screens/side_3_menu_ve_urunler/components/menu_ve_urunler_right_side.dart';
...
class MenuVeUrunlerControlArea extends StatelessWidget {
  const MenuVeUrunlerControlArea({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              if (Responsive.isMobile(context))
                const SizedBox(height: defaultPadding),
              if (Responsive.isMobile(context)) const MenuVeUrunlerRightSide(),
            ],
          ),
        ),
        if (!Responsive.isMobile(context))
