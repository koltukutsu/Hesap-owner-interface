...
import 'package:hesap_owner_interface/ui/screens/side_1_siparisler/components/siparisler_right_side.dart';
...
class SiparislerControlArea extends StatelessWidget {
  const SiparislerControlArea({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              if (Responsive.isMobile(context))
                const SizedBox(height: defaultPadding),
              if (Responsive.isMobile(context)) const SiparislerRightSide(),
            ],
          ),
        ),
